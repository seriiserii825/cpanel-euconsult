<footer class="footer section-dark" id="js-footer" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/i/footer-bg.jpg')">
    ...
    <div class="footer__content">
        <ul class="footer__contacts">
            ...
            <li class="footer__phone"><i class="footer__icon">
                ...
                ?>
                <a href="tel:<?php echo $phone_clear; ?>"><?php echo carbon_get_theme_option('crb_footer_before_phone'.get_lang()); ?>: <?php echo $phone; ?></a>
            </li>
        </ul>
...
<div class="socials-bottom">
    <ul class="socials-bottom__list">
        ...
        <li class="socials-bottom__item facebook">
            <a href="https://www.facebook.com/sharer/sharer.php?u=http://sovety.pp.ua">
